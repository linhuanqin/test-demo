<template>
    <div>
        ...
        <div class="bord-btm mar-btm">
            <Calendar :markDateMore="arr" @choseDay="choseDay"></Calendar>
        </div>
        <div class="pad-all">
            <div class="pos-rel mar-btm">
                <div class="mark2 text-center" style="width:16px;height:16px"></div>
                <div class="pos-abs fs14" style="left:30px;top:1px">正常</div>
            </div>
            <div class="pos-rel mar-btm">
...
<style>
    ...
    .mark2{
        background:#a0a087 !important;
    }
    .mark3{
        background:#f06292 !important;
    }
    .mark4{
        background:#f06252 !important;
    }
    .wh_chose_day{
